...
writeFileSync(`./wasm/pkg/paimon.wasm.js`, `export const data = "data:application/wasm;base64,${wasm.toString("base64")}";`);
writeFileSync(`./wasm/pkg/paimon.wasm.d.ts`, `export const data: string;`);
...
const glueJs = readFileSync(`./wasm/pkg/paimon.js`, "utf8")
...
const glueTs = readFileSync(`./wasm/pkg/paimon.d.ts`, "utf8")
...
writeFileSync(`./wasm/pkg/paimon.js`, glueJs + patchJs)
writeFileSync(`./wasm/pkg/paimon.d.ts`, glueTs + patchTs)
